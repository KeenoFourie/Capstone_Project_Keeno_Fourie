...
<template>
    <div>
        ...
        <div id="top_footer">
            ...
            <div id="about_us">
                <h5 class="footer_headings">About Us</h5>
                <router-link class="links_in_footer" to="/about">Our Trainers</router-link>
                <router-link class="links_in_footer" to="/about">Our Leadership</router-link>
                <router-link class="links_in_footer" to="/about">Our Mission</router-link>
            ...
            <div id="our_socials">
                ...
                <div id="social_icons">
                    <a id="facebook_link" href="https://www.facebook.com/profile.php?id=100085347340027" target="_blank">
                    ...
                    <a id="instagram_link" href="https://www.instagram.com/kinzboy10/" target="_blank">
                    ...
                    <a id="linkedin_link" href="https://www.linkedin.com/in/keeno-fourie-369062276/" target="_blank">
        ...
        <div id="bottom_footer">
            <p class="bottom_footer_text">Copyright &copy; 2023 Lift Off Life. All rights reserved.</p>
            <p class="bottom_footer_text">South Africa</p>
        </div>
...
#support, #about_us, #join_drive, #our_socials {
    padding: 2rem;
    display: flex;
